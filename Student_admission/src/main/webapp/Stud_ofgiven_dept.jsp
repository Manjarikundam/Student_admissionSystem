...
<body>
	<h1>Students of given department </h1>
	<br>
	<br>
	<form>
		<table border="1" align="center">
			...
			<%
			ArrayList<Selected_studentsBean> deptList = (ArrayList<Selected_studentsBean>) request.getAttribute("studentsOfGivenDepartment");
